Public Class frmTMBCP
    ...
    Dim conta1 As New contabancaria 'cria um objeto instanciado na classe contabancaria,
    'diga-mos que é o processo para abrir uma conta bancaria'
    Private Sub frmTMBCP_Load(sender As Object, e As EventArgs)
